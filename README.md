...
| `PATCH` | `/api/v1/catalogue/books/{idLibro}` | 5. Actualización parcial | `200 OK`, `400 Bad Request`, `404 Not Found`, `500 Internal Server Error` |
...
| `GET`    | `/api/payments/orders/{orderId}`                | 5.Consultar detalle de una orden específica          | —                        | Validar que exista, y que pertenezca al usuario                              | `200 OK`, `404 Not Found`                                        | —                                                                                |
